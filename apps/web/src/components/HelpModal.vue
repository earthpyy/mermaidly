      ...
      >
        <p class="m-0 mb-2">
          ...
          <a
            ...
            target="_blank"
            rel="noopener noreferrer"
            class="decoration-current/30 hover:decoration-current/60 underline underline-offset-2 transition-colors"
            :style="{ color: 'var(--fg-muted)' }"
            >Mermaid</a
          >
          project.
        ...
        <div class="flex items-center justify-center gap-1">
          ...
          <a
            ...
            target="_blank"
            rel="noopener noreferrer"
            class="decoration-current/30 hover:decoration-current/60 inline-flex items-center gap-1 underline underline-offset-2 transition-colors"
            :style="{ color: 'var(--fg-muted)' }"
            title="Claude Code"
          >
